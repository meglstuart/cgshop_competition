...
for inst in [10,15,20,25,30,35,40,45,50,60,70,80,90,100,200,300,400,500,600,700,800,900,1000,2000,3000,4000,5000,6000,7000,8000,9000,10000,20000,30000,40000,50000,60000,70000,80000,90000,100000]:
    ...
    max_solution_file =  "/Users/meg/repos/cgshop_competition/solutions/submission/euro-night-"+str(inst).zfill(7)+".maximum.solution"
    max_graphic_file = "/Users/meg/repos/cgshop_competition/solutions/plots/euro-night-"+str(inst).zfill(7)+".maximum.png"
    min_solution_file =  "/Users/meg/repos/cgshop_competition/solutions/submission/euro-night-"+str(inst).zfill(7)+".minimum.solution"
    min_graphic_file = "/Users/meg/repos/cgshop_competition/solutions/plots/euro-night-"+str(inst).zfill(7)+".minimum.png"
